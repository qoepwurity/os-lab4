...
printint(int fd, int xx, int base, int sgn)
{
 ...
 429:	0f b6 91 c4 0a 00 00 	movzbl 0xac4(%ecx),%edx
...
free(void *ap)
{
 ...
 62c:	a1 e0 0a 00 00       	mov    0xae0,%eax
 ...
 6f7:	a3 e0 0a 00 00       	mov    %eax,0xae0
}
 6fc:	90                   	nop
 6fd:	c9                   	leave  
 6fe:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 755:	83 c4 10             	add    $0x10,%esp
  return freep;
 758:	a1 e0 0a 00 00       	mov    0xae0,%eax
}
 75d:	c9                   	leave  
 75e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 771:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 774:	a1 e0 0a 00 00       	mov    0xae0,%eax
 779:	89 45 f0             	mov    %eax,-0x10(%ebp)
 77c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 780:	75 23                	jne    7a5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 782:	c7 45 f0 d8 0a 00 00 	movl   $0xad8,-0x10(%ebp)
 789:	8b 45 f0             	mov    -0x10(%ebp),%eax
 78c:	a3 e0 0a 00 00       	mov    %eax,0xae0
 791:	a1 e0 0a 00 00       	mov    0xae0,%eax
 796:	a3 d8 0a 00 00       	mov    %eax,0xad8
    base.s.size = 0;
 ...
 7f8:	a3 e0 0a 00 00       	mov    %eax,0xae0
      return (void*)(p + 1);
 ...
 803:	eb 3b                	jmp    840 <malloc+0xe1>
    ...
    if(p == freep)
 805:	a1 e0 0a 00 00       	mov    0xae0,%eax
