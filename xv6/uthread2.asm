...
thread_schedule(void)
{
  ...
  9d:	6a 02                	push   $0x2
  9f:	e8 75 08 00 00       	call   919 <printf>
...
child_thread(void)
{
 ...
 373:	68 f6 0c 00 00       	push   $0xcf6
 378:	6a 01                	push   $0x1
 37a:	e8 9a 05 00 00       	call   919 <printf>
 ...
 393:	50                   	push   %eax
 394:	68 0c 0d 00 00       	push   $0xd0c
 399:	6a 01                	push   $0x1
 39b:	e8 79 05 00 00       	call   919 <printf>
 ...
 3b0:	68 1f 0d 00 00       	push   $0xd1f
 3b5:	6a 01                	push   $0x1
 3b7:	e8 5d 05 00 00       	call   919 <printf>
...
mythread(void)
{
 ...
 44a:	68 33 0d 00 00       	push   $0xd33
 44f:	6a 01                	push   $0x1
 451:	e8 c3 04 00 00       	call   919 <printf>
 456:	83 c4 10             	add    $0x10,%esp
  int i;
  printf(1, "my thread running\n");
 459:	83 ec 08             	sub    $0x8,%esp
 45c:	68 41 0d 00 00       	push   $0xd41
 461:	6a 01                	push   $0x1
 463:	e8 b1 04 00 00       	call   919 <printf>
 ...
 496:	68 54 0d 00 00       	push   $0xd54
 49b:	6a 01                	push   $0x1
 49d:	e8 77 04 00 00       	call   919 <printf>
...
putc(int fd, char c)
{
 ...
 85d:	e8 3b ff ff ff       	call   79d <write>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 86b:	83 ec 28             	sub    $0x28,%esp
  ...
  neg = 0;
 86e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
 875:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 879:	74 17                	je     892 <printint+0x2a>
 87b:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 87f:	79 11                	jns    892 <printint+0x2a>
    neg = 1;
 881:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
 888:	8b 45 0c             	mov    0xc(%ebp),%eax
 88b:	f7 d8                	neg    %eax
 88d:	89 45 ec             	mov    %eax,-0x14(%ebp)
 890:	eb 06                	jmp    898 <printint+0x30>
  } else {
    x = xx;
 ...
 895:	89 45 ec             	mov    %eax,-0x14(%ebp)
  ...
  i = 0;
 898:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 89f:	8b 4d 10             	mov    0x10(%ebp),%ecx
 8a2:	8b 45 ec             	mov    -0x14(%ebp),%eax
 8a5:	ba 00 00 00 00       	mov    $0x0,%edx
 8aa:	f7 f1                	div    %ecx
 8ac:	89 d1                	mov    %edx,%ecx
 8ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8b1:	8d 50 01             	lea    0x1(%eax),%edx
 8b4:	89 55 f4             	mov    %edx,-0xc(%ebp)
 8b7:	0f b6 91 98 10 00 00 	movzbl 0x1098(%ecx),%edx
 8be:	88 54 05 dc          	mov    %dl,-0x24(%ebp,%eax,1)
  }while((x /= base) != 0);
 ...
 8d2:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 8d6:	75 c7                	jne    89f <printint+0x37>
  if(neg)
 8d8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8dc:	74 2d                	je     90b <printint+0xa3>
    buf[i++] = '-';
 8de:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8e1:	8d 50 01             	lea    0x1(%eax),%edx
 8e4:	89 55 f4             	mov    %edx,-0xc(%ebp)
 8e7:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 8ec:	eb 1d                	jmp    90b <printint+0xa3>
    putc(fd, buf[i]);
 8ee:	8d 55 dc             	lea    -0x24(%ebp),%edx
 ...
 903:	e8 3d ff ff ff       	call   845 <putc>
 908:	83 c4 10             	add    $0x10,%esp
  while(--i >= 0)
 90b:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
 90f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 913:	79 d9                	jns    8ee <printint+0x86>
}
 915:	90                   	nop
 916:	90                   	nop
 917:	c9                   	leave  
...
printf(int fd, char *fmt, ...)
{
 ...
 936:	e9 59 01 00 00       	jmp    a94 <printf+0x17b>
    c = fmt[i] & 0xff;
 ...
 949:	25 ff 00 00 00       	and    $0xff,%eax
 94e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
 951:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 955:	75 2c                	jne    983 <printf+0x6a>
      if(c == '%'){
 957:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 95b:	75 0c                	jne    969 <printf+0x50>
        state = '%';
 95d:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 964:	e9 27 01 00 00       	jmp    a90 <printf+0x177>
      } else {
        putc(fd, c);
 ...
 972:	50                   	push   %eax
 973:	ff 75 08             	push   0x8(%ebp)
 976:	e8 ca fe ff ff       	call   845 <putc>
 97b:	83 c4 10             	add    $0x10,%esp
 97e:	e9 0d 01 00 00       	jmp    a90 <printf+0x177>
      }
    } else if(state == '%'){
 983:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 987:	0f 85 03 01 00 00    	jne    a90 <printf+0x177>
      if(c == 'd'){
 98d:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 991:	75 1e                	jne    9b1 <printf+0x98>
        printint(fd, *ap, 10, 1);
 ...
 9a0:	e8 c3 fe ff ff       	call   868 <printint>
 9a5:	83 c4 10             	add    $0x10,%esp
        ap++;
 9a8:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 9ac:	e9 d8 00 00 00       	jmp    a89 <printf+0x170>
      } else if(c == 'x' || c == 'p'){
 9b1:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 9b5:	74 06                	je     9bd <printf+0xa4>
 9b7:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 9bb:	75 1e                	jne    9db <printf+0xc2>
        printint(fd, *ap, 16, 0);
 ...
 9ca:	e8 99 fe ff ff       	call   868 <printint>
 9cf:	83 c4 10             	add    $0x10,%esp
        ap++;
 9d2:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 9d6:	e9 ae 00 00 00       	jmp    a89 <printf+0x170>
      } else if(c == 's'){
 9db:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 9df:	75 43                	jne    a24 <printf+0x10b>
        s = (char*)*ap;
 9e1:	8b 45 e8             	mov    -0x18(%ebp),%eax
 ...
 9f1:	75 25                	jne    a18 <printf+0xff>
          s = "(null)";
 9f3:	c7 45 f4 65 0d 00 00 	movl   $0xd65,-0xc(%ebp)
        while(*s != 0){
 9fa:	eb 1c                	jmp    a18 <printf+0xff>
          putc(fd, *s);
 ...
 a0c:	e8 34 fe ff ff       	call   845 <putc>
 a11:	83 c4 10             	add    $0x10,%esp
          s++;
 a14:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
        while(*s != 0){
 a18:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a1b:	0f b6 00             	movzbl (%eax),%eax
 a1e:	84 c0                	test   %al,%al
 a20:	75 da                	jne    9fc <printf+0xe3>
 a22:	eb 65                	jmp    a89 <printf+0x170>
        }
      } else if(c == 'c'){
 a24:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 a28:	75 1d                	jne    a47 <printf+0x12e>
        putc(fd, *ap);
 ...
 a35:	50                   	push   %eax
 a36:	ff 75 08             	push   0x8(%ebp)
 a39:	e8 07 fe ff ff       	call   845 <putc>
 a3e:	83 c4 10             	add    $0x10,%esp
        ap++;
 a41:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 a45:	eb 42                	jmp    a89 <printf+0x170>
      } else if(c == '%'){
 a47:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 a4b:	75 17                	jne    a64 <printf+0x14b>
        putc(fd, c);
 a4d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 a50:	0f be c0             	movsbl %al,%eax
 a53:	83 ec 08             	sub    $0x8,%esp
 a56:	50                   	push   %eax
 a57:	ff 75 08             	push   0x8(%ebp)
 a5a:	e8 e6 fd ff ff       	call   845 <putc>
 a5f:	83 c4 10             	add    $0x10,%esp
 a62:	eb 25                	jmp    a89 <printf+0x170>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 a64:	83 ec 08             	sub    $0x8,%esp
 a67:	6a 25                	push   $0x25
 a69:	ff 75 08             	push   0x8(%ebp)
 a6c:	e8 d4 fd ff ff       	call   845 <putc>
 a71:	83 c4 10             	add    $0x10,%esp
        putc(fd, c);
 a74:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 a77:	0f be c0             	movsbl %al,%eax
 a7a:	83 ec 08             	sub    $0x8,%esp
 a7d:	50                   	push   %eax
 a7e:	ff 75 08             	push   0x8(%ebp)
 a81:	e8 bf fd ff ff       	call   845 <putc>
 a86:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
 a89:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  for(i = 0; fmt[i]; i++){
 a90:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 a94:	8b 55 0c             	mov    0xc(%ebp),%edx
 a97:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a9a:	01 d0                	add    %edx,%eax
 a9c:	0f b6 00             	movzbl (%eax),%eax
 a9f:	84 c0                	test   %al,%al
 aa1:	0f 85 94 fe ff ff    	jne    93b <printf+0x22>
    }
  }
}
 aa7:	90                   	nop
...
free(void *ap)
{
 ...
 b78:	eb 08                	jmp    b82 <free+0xd7>
  } else
    p->s.ptr = bp;
 b7a:	8b 45 fc             	mov    -0x4(%ebp),%eax
 b7d:	8b 55 f8             	mov    -0x8(%ebp),%edx
 b80:	89 10                	mov    %edx,(%eax)
  freep = p;
 b82:	8b 45 fc             	mov    -0x4(%ebp),%eax
 b85:	a3 88 51 01 00       	mov    %eax,0x15188
}
 b8a:	90                   	nop
 b8b:	c9                   	leave  
 b8c:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 bdd:	50                   	push   %eax
 bde:	e8 c8 fe ff ff       	call   aab <free>
 be3:	83 c4 10             	add    $0x10,%esp
  return freep;
 be6:	a1 88 51 01 00       	mov    0x15188,%eax
}
 beb:	c9                   	leave  
 bec:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 bf6:	83 c0 07             	add    $0x7,%eax
 bf9:	c1 e8 03             	shr    $0x3,%eax
 bfc:	83 c0 01             	add    $0x1,%eax
 bff:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 c02:	a1 88 51 01 00       	mov    0x15188,%eax
 c07:	89 45 f0             	mov    %eax,-0x10(%ebp)
 c0a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 c0e:	75 23                	jne    c33 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 c10:	c7 45 f0 80 51 01 00 	movl   $0x15180,-0x10(%ebp)
 c17:	8b 45 f0             	mov    -0x10(%ebp),%eax
 c1a:	a3 88 51 01 00       	mov    %eax,0x15188
 c1f:	a1 88 51 01 00       	mov    0x15188,%eax
 c24:	a3 80 51 01 00       	mov    %eax,0x15180
    base.s.size = 0;
 c29:	c7 05 84 51 01 00 00 	movl   $0x0,0x15184
 c30:	00 00 00 
  }
 ...
 c41:	39 45 ec             	cmp    %eax,-0x14(%ebp)
 c44:	77 4d                	ja     c93 <malloc+0xa6>
      if(p->s.size == nunits)
 c46:	8b 45 f4             	mov    -0xc(%ebp),%eax
 c49:	8b 40 04             	mov    0x4(%eax),%eax
 c4c:	39 45 ec             	cmp    %eax,-0x14(%ebp)
 c4f:	75 0c                	jne    c5d <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
 c51:	8b 45 f4             	mov    -0xc(%ebp),%eax
 c54:	8b 10                	mov    (%eax),%edx
 c56:	8b 45 f0             	mov    -0x10(%ebp),%eax
 c59:	89 10                	mov    %edx,(%eax)
 c5b:	eb 26                	jmp    c83 <malloc+0x96>
      else {
        p->s.size -= nunits;
 c5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
 c60:	8b 40 04             	mov    0x4(%eax),%eax
 c63:	2b 45 ec             	sub    -0x14(%ebp),%eax
 c66:	89 c2                	mov    %eax,%edx
 c68:	8b 45 f4             	mov    -0xc(%ebp),%eax
 c6b:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
 c6e:	8b 45 f4             	mov    -0xc(%ebp),%eax
 c71:	8b 40 04             	mov    0x4(%eax),%eax
 c74:	c1 e0 03             	shl    $0x3,%eax
 c77:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
 c7a:	8b 45 f4             	mov    -0xc(%ebp),%eax
 c7d:	8b 55 ec             	mov    -0x14(%ebp),%edx
 c80:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
 c83:	8b 45 f0             	mov    -0x10(%ebp),%eax
 c86:	a3 88 51 01 00       	mov    %eax,0x15188
      return (void*)(p + 1);
 c8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
 c8e:	83 c0 08             	add    $0x8,%eax
 c91:	eb 3b                	jmp    cce <malloc+0xe1>
    }
    if(p == freep)
 c93:	a1 88 51 01 00       	mov    0x15188,%eax
 c98:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 c9b:	75 1e                	jne    cbb <malloc+0xce>
      if((p = morecore(nunits)) == 0)
 c9d:	83 ec 0c             	sub    $0xc,%esp
 ca0:	ff 75 ec             	push   -0x14(%ebp)
 ca3:	e8 e5 fe ff ff       	call   b8d <morecore>
 ca8:	83 c4 10             	add    $0x10,%esp
 cab:	89 45 f4             	mov    %eax,-0xc(%ebp)
 cae:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 cb2:	75 07                	jne    cbb <malloc+0xce>
        return 0;
 cb4:	b8 00 00 00 00       	mov    $0x0,%eax
 cb9:	eb 13                	jmp    cce <malloc+0xe1>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 cc6:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
 cc9:	e9 6d ff ff ff       	jmp    c3b <malloc+0x4e>
  }
}
 cce:	c9                   	leave  
 ccf:	c3                   	ret    
