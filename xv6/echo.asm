...
main(int argc, char *argv[])
{
  ...
  27:	ba 17 08 00 00       	mov    $0x817,%edx
  2c:	eb 05                	jmp    33 <main+0x33>
  2e:	ba 19 08 00 00       	mov    $0x819,%edx
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fe:	0f b6 91 70 0a 00 00 	movzbl 0xa70(%ecx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 538:	75 25                	jne    55f <printf+0xff>
          s = "(null)";
 53a:	c7 45 f4 20 08 00 00 	movl   $0x820,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6cc:	a3 8c 0a 00 00       	mov    %eax,0xa8c
}
 6d1:	90                   	nop
 6d2:	c9                   	leave  
 6d3:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 6f3:	50                   	push   %eax
 6f4:	e8 4b fc ff ff       	call   344 <sbrk>
 ...
 72a:	83 c4 10             	add    $0x10,%esp
  return freep;
 72d:	a1 8c 0a 00 00       	mov    0xa8c,%eax
}
 732:	c9                   	leave  
 733:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 746:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 749:	a1 8c 0a 00 00       	mov    0xa8c,%eax
 74e:	89 45 f0             	mov    %eax,-0x10(%ebp)
 751:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 755:	75 23                	jne    77a <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 757:	c7 45 f0 84 0a 00 00 	movl   $0xa84,-0x10(%ebp)
 75e:	8b 45 f0             	mov    -0x10(%ebp),%eax
 761:	a3 8c 0a 00 00       	mov    %eax,0xa8c
 766:	a1 8c 0a 00 00       	mov    0xa8c,%eax
 76b:	a3 84 0a 00 00       	mov    %eax,0xa84
    base.s.size = 0;
 770:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 777:	00 00 00 
  }
 ...
 7cd:	a3 8c 0a 00 00       	mov    %eax,0xa8c
      return (void*)(p + 1);
 ...
 7d8:	eb 3b                	jmp    815 <malloc+0xe1>
    ...
    if(p == freep)
 7da:	a1 8c 0a 00 00       	mov    0xa8c,%eax
