...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ee:	6a 54                	push   $0x54
     3f0:	e8 5b 0f 00 00       	call   1350 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     424:	6a 18                	push   $0x18
     426:	e8 25 0f 00 00       	call   1350 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     487:	6a 0c                	push   $0xc
     489:	e8 c2 0e 00 00       	call   1350 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4cf:	6a 0c                	push   $0xc
     4d1:	e8 7a 0e 00 00       	call   1350 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     517:	6a 08                	push   $0x8
     519:	e8 32 0e 00 00       	call   1350 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     575:	50                   	push   %eax
     576:	68 ac 19 00 00       	push   $0x19ac
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     61d:	50                   	push   %eax
     61e:	68 ac 19 00 00       	push   $0x19ac
     ...
     63b:	50                   	push   %eax
     63c:	68 b4 19 00 00       	push   $0x19b4
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67e:	50                   	push   %eax
     67f:	68 ac 19 00 00       	push   $0x19ac
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6c5:	50                   	push   %eax
     6c6:	68 ac 19 00 00       	push   $0x19ac
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     749:	68 9a 14 00 00       	push   $0x149a
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     76b:	50                   	push   %eax
     76c:	68 9b 14 00 00       	push   $0x149b
     771:	6a 02                	push   $0x2
     773:	e8 04 09 00 00       	call   107c <printf>
     778:	83 c4 10             	add    $0x10,%esp
    panic("syntax");
     77b:	83 ec 0c             	sub    $0xc,%esp
     77e:	68 aa 14 00 00       	push   $0x14aa
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e3:	68 b1 14 00 00       	push   $0x14b1
  ...
  if(peek(ps, es, ";")){
     ...
     7fd:	68 b3 14 00 00       	push   $0x14b3
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86b:	68 b5 14 00 00       	push   $0x14b5
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fa:	68 b7 14 00 00       	push   $0x14b7
  ...
  while(peek(ps, es, "<>")){
     ...
     984:	68 d4 14 00 00       	push   $0x14d4
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9ad:	68 d7 14 00 00       	push   $0x14d7
    ...
    panic("parseblock");
     ...
     9c7:	68 d9 14 00 00       	push   $0x14d9
  ...
  if(!peek(ps, es, ")"))
     ...
     9fd:	68 e4 14 00 00       	push   $0x14e4
    ...
    panic("syntax - missing )");
     ...
     a17:	68 e6 14 00 00       	push   $0x14e6
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a5b:	68 d7 14 00 00       	push   $0x14d7
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae5:	68 aa 14 00 00       	push   $0x14aa
    ...
    if(argc >= MAXARGS)
     ...
     b1c:	68 f9 14 00 00       	push   $0x14f9
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b43:	68 07 15 00 00       	push   $0x1507
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba9:	8b 04 85 0c 15 00 00 	mov    0x150c(,%eax,4),%eax
     bb0:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
00000fa0 <printpt>:
     ...
     fa0:	b8 1b 00 00 00       	mov    $0x1b,%eax
     fa5:	cd 40                	int    $0x40
     fa7:	c3                   	ret    
...
putc(int fd, char c)
{
     ...
     fab:	83 ec 18             	sub    $0x18,%esp
     fae:	8b 45 0c             	mov    0xc(%ebp),%eax
     fb1:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
     fb4:	83 ec 04             	sub    $0x4,%esp
     fb7:	6a 01                	push   $0x1
     fb9:	8d 45 f4             	lea    -0xc(%ebp),%eax
     fbc:	50                   	push   %eax
     fbd:	ff 75 08             	push   0x8(%ebp)
     fc0:	e8 33 ff ff ff       	call   ef8 <write>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
     fd1:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
     fd8:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
     fdc:	74 17                	je     ff5 <printint+0x2a>
     fde:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
     fe2:	79 11                	jns    ff5 <printint+0x2a>
    neg = 1;
     fe4:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
     feb:	8b 45 0c             	mov    0xc(%ebp),%eax
     fee:	f7 d8                	neg    %eax
     ff0:	89 45 ec             	mov    %eax,-0x14(%ebp)
     ff3:	eb 06                	jmp    ffb <printint+0x30>
  } else {
    x = xx;
  ...
  i = 0;
     ffb:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    ...
    100d:	f7 f1                	div    %ecx
    100f:	89 d1                	mov    %edx,%ecx
    1011:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1014:	8d 50 01             	lea    0x1(%eax),%edx
    1017:	89 55 f4             	mov    %edx,-0xc(%ebp)
    101a:	0f b6 91 bc 19 00 00 	movzbl 0x19bc(%ecx),%edx
    1021:	88 54 05 dc          	mov    %dl,-0x24(%ebp,%eax,1)
  }while((x /= base) != 0);
    1025:	8b 4d 10             	mov    0x10(%ebp),%ecx
    1028:	8b 45 ec             	mov    -0x14(%ebp),%eax
    102b:	ba 00 00 00 00       	mov    $0x0,%edx
    1030:	f7 f1                	div    %ecx
    1032:	89 45 ec             	mov    %eax,-0x14(%ebp)
    1035:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1039:	75 c7                	jne    1002 <printint+0x37>
  if(neg)
    103b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    103f:	74 2d                	je     106e <printint+0xa3>
    buf[i++] = '-';
    1041:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1044:	8d 50 01             	lea    0x1(%eax),%edx
    1047:	89 55 f4             	mov    %edx,-0xc(%ebp)
    104a:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    104f:	eb 1d                	jmp    106e <printint+0xa3>
    putc(fd, buf[i]);
    1051:	8d 55 dc             	lea    -0x24(%ebp),%edx
    1054:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1057:	01 d0                	add    %edx,%eax
    1059:	0f b6 00             	movzbl (%eax),%eax
    105c:	0f be c0             	movsbl %al,%eax
    105f:	83 ec 08             	sub    $0x8,%esp
    1062:	50                   	push   %eax
    1063:	ff 75 08             	push   0x8(%ebp)
    1066:	e8 3d ff ff ff       	call   fa8 <putc>
    106b:	83 c4 10             	add    $0x10,%esp
  while(--i >= 0)
    106e:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    1072:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1076:	79 d9                	jns    1051 <printint+0x86>
}
    1078:	90                   	nop
    1079:	90                   	nop
    107a:	c9                   	leave  
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    10d5:	50                   	push   %eax
    10d6:	ff 75 08             	push   0x8(%ebp)
    10d9:	e8 ca fe ff ff       	call   fa8 <putc>
    ...
    10fd:	6a 0a                	push   $0xa
    10ff:	50                   	push   %eax
    1100:	ff 75 08             	push   0x8(%ebp)
    1103:	e8 c3 fe ff ff       	call   fcb <printint>
    ...
    112d:	e8 99 fe ff ff       	call   fcb <printint>
    ...
    116f:	e8 34 fe ff ff       	call   fa8 <putc>
    ...
    1198:	50                   	push   %eax
    1199:	ff 75 08             	push   0x8(%ebp)
    119c:	e8 07 fe ff ff       	call   fa8 <putc>
    ...
    11b9:	50                   	push   %eax
    11ba:	ff 75 08             	push   0x8(%ebp)
    11bd:	e8 e6 fd ff ff       	call   fa8 <putc>
    ...
    11cf:	e8 d4 fd ff ff       	call   fa8 <putc>
    ...
    11e0:	50                   	push   %eax
    11e1:	ff 75 08             	push   0x8(%ebp)
    11e4:	e8 bf fd ff ff       	call   fa8 <putc>
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    ...
    1217:	83 e8 08             	sub    $0x8,%eax
    121a:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    121d:	a1 4c 1a 00 00       	mov    0x1a4c,%eax
    1222:	89 45 fc             	mov    %eax,-0x4(%ebp)
    1225:	eb 24                	jmp    124b <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1227:	8b 45 fc             	mov    -0x4(%ebp),%eax
    122a:	8b 00                	mov    (%eax),%eax
    122c:	39 45 fc             	cmp    %eax,-0x4(%ebp)
    122f:	72 12                	jb     1243 <free+0x35>
    1231:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1234:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1237:	77 24                	ja     125d <free+0x4f>
    1239:	8b 45 fc             	mov    -0x4(%ebp),%eax
    123c:	8b 00                	mov    (%eax),%eax
    123e:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    1241:	72 1a                	jb     125d <free+0x4f>
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1251:	76 d4                	jbe    1227 <free+0x19>
    1253:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1256:	8b 00                	mov    (%eax),%eax
    1258:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    125b:	73 ca                	jae    1227 <free+0x19>
      break;
  if(bp + bp->s.size == p->s.ptr){
    125d:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1260:	8b 40 04             	mov    0x4(%eax),%eax
    1263:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    12f6:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    12fd:	77 07                	ja     1306 <morecore+0x16>
    nu = 4096;
    12ff:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    1306:	8b 45 08             	mov    0x8(%ebp),%eax
    1309:	c1 e0 03             	shl    $0x3,%eax
    130c:	83 ec 0c             	sub    $0xc,%esp
    130f:	50                   	push   %eax
    1310:	e8 4b fc ff ff       	call   f60 <sbrk>
    1315:	83 c4 10             	add    $0x10,%esp
    1318:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    131b:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    131f:	75 07                	jne    1328 <morecore+0x38>
    return 0;
    1321:	b8 00 00 00 00       	mov    $0x0,%eax
    1326:	eb 26                	jmp    134e <morecore+0x5e>
  hp = (Header*)p;
    1328:	8b 45 f4             	mov    -0xc(%ebp),%eax
    132b:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    132e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1331:	8b 55 08             	mov    0x8(%ebp),%edx
    1334:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    1337:	8b 45 f0             	mov    -0x10(%ebp),%eax
    133a:	83 c0 08             	add    $0x8,%eax
    133d:	83 ec 0c             	sub    $0xc,%esp
    1340:	50                   	push   %eax
    1341:	e8 c8 fe ff ff       	call   120e <free>
    1346:	83 c4 10             	add    $0x10,%esp
  return freep;
    1349:	a1 4c 1a 00 00       	mov    0x1a4c,%eax
}
    134e:	c9                   	leave  
    134f:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    13d7:	c1 e0 03             	shl    $0x3,%eax
    13da:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    13dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13e0:	8b 55 ec             	mov    -0x14(%ebp),%edx
    13e3:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    13e6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13e9:	a3 4c 1a 00 00       	mov    %eax,0x1a4c
      return (void*)(p + 1);
    13ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13f1:	83 c0 08             	add    $0x8,%eax
    13f4:	eb 3b                	jmp    1431 <malloc+0xe1>
    }
    if(p == freep)
    13f6:	a1 4c 1a 00 00       	mov    0x1a4c,%eax
    13fb:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    13fe:	75 1e                	jne    141e <malloc+0xce>
      if((p = morecore(nunits)) == 0)
    1400:	83 ec 0c             	sub    $0xc,%esp
    1403:	ff 75 ec             	push   -0x14(%ebp)
    1406:	e8 e5 fe ff ff       	call   12f0 <morecore>
    140b:	83 c4 10             	add    $0x10,%esp
    140e:	89 45 f4             	mov    %eax,-0xc(%ebp)
    1411:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1415:	75 07                	jne    141e <malloc+0xce>
        return 0;
    1417:	b8 00 00 00 00       	mov    $0x0,%eax
    141c:	eb 13                	jmp    1431 <malloc+0xe1>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
    142c:	e9 6d ff ff ff       	jmp    139e <malloc+0x4e>
  }
}
    1431:	c9                   	leave  
    1432:	c3                   	ret    
