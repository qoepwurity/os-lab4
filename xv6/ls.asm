...
fmtname(char *path)
{
  ...
  98:	05 f8 0d 00 00       	add    $0xdf8,%eax
  ...
  return buf;
  ac:	b8 f8 0d 00 00       	mov    $0xdf8,%eax
}
...
ls(char *path)
{
  ...
  e1:	68 f4 0a 00 00       	push   $0xaf4
  e6:	6a 02                	push   $0x2
  e8:	e8 50 06 00 00       	call   73d <printf>
 ...
 114:	68 08 0b 00 00       	push   $0xb08
 119:	6a 02                	push   $0x2
 11b:	e8 1d 06 00 00       	call   73d <printf>
 ...
 175:	53                   	push   %ebx
 176:	50                   	push   %eax
 177:	68 1c 0b 00 00       	push   $0xb1c
 17c:	6a 01                	push   $0x1
 17e:	e8 ba 05 00 00       	call   73d <printf>
 ...
 257:	50                   	push   %eax
 258:	68 08 0b 00 00       	push   $0xb08
 25d:	6a 01                	push   $0x1
 25f:	e8 d9 04 00 00       	call   73d <printf>
 ...
 296:	53                   	push   %ebx
 297:	50                   	push   %eax
 298:	68 1c 0b 00 00       	push   $0xb1c
 29d:	6a 01                	push   $0x1
 29f:	e8 99 04 00 00       	call   73d <printf>
...
00000661 <printpt>:
 ...
 661:	b8 1b 00 00 00       	mov    $0x1b,%eax
 666:	cd 40                	int    $0x40
 668:	c3                   	ret    
...
putc(int fd, char c)
{
 ...
 681:	e8 33 ff ff ff       	call   5b9 <write>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6db:	0f b6 91 e4 0d 00 00 	movzbl 0xde4(%ecx),%edx
 6e2:	88 54 05 dc          	mov    %dl,-0x24(%ebp,%eax,1)
  }while((x /= base) != 0);
 ...
 6fa:	75 c7                	jne    6c3 <printint+0x37>
  if(neg)
 6fc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 700:	74 2d                	je     72f <printint+0xa3>
    buf[i++] = '-';
 702:	8b 45 f4             	mov    -0xc(%ebp),%eax
 705:	8d 50 01             	lea    0x1(%eax),%edx
 708:	89 55 f4             	mov    %edx,-0xc(%ebp)
 70b:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 710:	eb 1d                	jmp    72f <printint+0xa3>
    putc(fd, buf[i]);
...
printf(int fd, char *fmt, ...)
{
 ...
 75a:	e9 59 01 00 00       	jmp    8b8 <printf+0x17b>
    c = fmt[i] & 0xff;
 ...
 788:	e9 27 01 00 00       	jmp    8b4 <printf+0x177>
      } else {
        putc(fd, c);
 ...
 79a:	e8 ca fe ff ff       	call   669 <putc>
 79f:	83 c4 10             	add    $0x10,%esp
 7a2:	e9 0d 01 00 00       	jmp    8b4 <printf+0x177>
      }
    } else if(state == '%'){
 7a7:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 7ab:	0f 85 03 01 00 00    	jne    8b4 <printf+0x177>
      if(c == 'd'){
 7b1:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 7b5:	75 1e                	jne    7d5 <printf+0x98>
        printint(fd, *ap, 10, 1);
 ...
 7c4:	e8 c3 fe ff ff       	call   68c <printint>
 7c9:	83 c4 10             	add    $0x10,%esp
        ap++;
 7cc:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 7d0:	e9 d8 00 00 00       	jmp    8ad <printf+0x170>
      } else if(c == 'x' || c == 'p'){
 7d5:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 7d9:	74 06                	je     7e1 <printf+0xa4>
 7db:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 7df:	75 1e                	jne    7ff <printf+0xc2>
        printint(fd, *ap, 16, 0);
 ...
 7ee:	e8 99 fe ff ff       	call   68c <printint>
 7f3:	83 c4 10             	add    $0x10,%esp
        ap++;
 7f6:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 7fa:	e9 ae 00 00 00       	jmp    8ad <printf+0x170>
      } else if(c == 's'){
 7ff:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 803:	75 43                	jne    848 <printf+0x10b>
        s = (char*)*ap;
 ...
 815:	75 25                	jne    83c <printf+0xff>
          s = "(null)";
 817:	c7 45 f4 3e 0b 00 00 	movl   $0xb3e,-0xc(%ebp)
        while(*s != 0){
 81e:	eb 1c                	jmp    83c <printf+0xff>
          putc(fd, *s);
 ...
 830:	e8 34 fe ff ff       	call   669 <putc>
 835:	83 c4 10             	add    $0x10,%esp
          s++;
 838:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
        while(*s != 0){
 83c:	8b 45 f4             	mov    -0xc(%ebp),%eax
 83f:	0f b6 00             	movzbl (%eax),%eax
 842:	84 c0                	test   %al,%al
 844:	75 da                	jne    820 <printf+0xe3>
 846:	eb 65                	jmp    8ad <printf+0x170>
        }
      } else if(c == 'c'){
 848:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 84c:	75 1d                	jne    86b <printf+0x12e>
        putc(fd, *ap);
 ...
 869:	eb 42                	jmp    8ad <printf+0x170>
      } else if(c == '%'){
 86b:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 86f:	75 17                	jne    888 <printf+0x14b>
        putc(fd, c);
 ...
 87e:	e8 e6 fd ff ff       	call   669 <putc>
 883:	83 c4 10             	add    $0x10,%esp
 886:	eb 25                	jmp    8ad <printf+0x170>
      } else {
 ...
 890:	e8 d4 fd ff ff       	call   669 <putc>
 ...
 8a5:	e8 bf fd ff ff       	call   669 <putc>
 ...
 8c5:	0f 85 94 fe ff ff    	jne    75f <printf+0x22>
    }
  }
}
 8cb:	90                   	nop
...
free(void *ap)
{
 ...
 912:	76 d4                	jbe    8e8 <free+0x19>
 914:	8b 45 fc             	mov    -0x4(%ebp),%eax
 917:	8b 00                	mov    (%eax),%eax
 919:	39 45 f8             	cmp    %eax,-0x8(%ebp)
 91c:	73 ca                	jae    8e8 <free+0x19>
      break;
 ...
 979:	39 45 f8             	cmp    %eax,-0x8(%ebp)
 97c:	75 20                	jne    99e <free+0xcf>
    p->s.size += bp->s.size;
 ...
 99c:	eb 08                	jmp    9a6 <free+0xd7>
  } else
    p->s.ptr = bp;
 99e:	8b 45 fc             	mov    -0x4(%ebp),%eax
 9a1:	8b 55 f8             	mov    -0x8(%ebp),%edx
 9a4:	89 10                	mov    %edx,(%eax)
  freep = p;
 9a6:	8b 45 fc             	mov    -0x4(%ebp),%eax
 9a9:	a3 10 0e 00 00       	mov    %eax,0xe10
}
 9ae:	90                   	nop
 9af:	c9                   	leave  
 9b0:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 9d0:	50                   	push   %eax
 9d1:	e8 4b fc ff ff       	call   621 <sbrk>
 ...
 a01:	50                   	push   %eax
 a02:	e8 c8 fe ff ff       	call   8cf <free>
 a07:	83 c4 10             	add    $0x10,%esp
  return freep;
 a0a:	a1 10 0e 00 00       	mov    0xe10,%eax
}
 a0f:	c9                   	leave  
 a10:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a23:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a26:	a1 10 0e 00 00       	mov    0xe10,%eax
 a2b:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a2e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a32:	75 23                	jne    a57 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a34:	c7 45 f0 08 0e 00 00 	movl   $0xe08,-0x10(%ebp)
 a3b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a3e:	a3 10 0e 00 00       	mov    %eax,0xe10
 a43:	a1 10 0e 00 00       	mov    0xe10,%eax
 a48:	a3 08 0e 00 00       	mov    %eax,0xe08
    base.s.size = 0;
 a4d:	c7 05 0c 0e 00 00 00 	movl   $0x0,0xe0c
 a54:	00 00 00 
  }
 ...
 aaa:	a3 10 0e 00 00       	mov    %eax,0xe10
      return (void*)(p + 1);
